		...
		<div id="carouselHome" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
			<div class="carousel-item active">
			  <img class="d-block w-100" src="imagenes/carrusel1.jpg" height=820px> <!-- Imagen 1 del carrusel -->
			...
			<div class="carousel-item">
			  <img class="d-block w-100" src="imagenes/carrusel2.jpg" height=820px> <!-- Imagen 2 del carrusel -->
			  	  <div class="carousel-caption d-none d-md-block">
			...
			<div class="carousel-item">
			  <img class="d-block w-100" src="imagenes/carrusel3.jpg" height=820px> <!-- Imagen 3 del carrusel -->
			  	  <div class="carousel-caption d-none d-md-block">
